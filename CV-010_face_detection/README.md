...
2. Проверьте, что путь к файлу в `app.py` указан правильно
...
- `dist/app.exe` - 145 МБ
- `build/app/app.pkg` - 145 МБ

Файлы вынесены из репозитория и доступны для скачивания:

[app.exe — Яндекс Диск](https://disk.yandex.ru/d/kC3Y-VNp8wCJkw)

...
#### backlog
- План
- Проект находится в очереди
- Следующий проект

#### ongoing
- Проект находится в активной разработке
- Регулярные комментарии (коммиты) и обновления
- Активное взаимодействие с AI-ассистентом
- Проводится обзор проекта (Review)
...
В файле `README.md` используются следующие поля для обозначения статуса:
